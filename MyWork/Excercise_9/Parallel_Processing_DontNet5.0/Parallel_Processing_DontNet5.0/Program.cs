...
namespace ThreadingSampleNetCorev5._0
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Run Job in its Own Thread");
            stopWatch.Start();
            parallel.StartEachJobInOwnThread(12, Workerfuntion);
            stopWatch.Stop();
            Console.WriteLine("Type: Run Job in its Own Thread, " + " Number of Processors: " + numberOfProcessors + "; Total Threads: ");
            ...
            stopWatch.Stop();
            Console.WriteLine("Type: Run Jobs in its Sequence, " + " Number of Processors: " + numberOfProcessors + "; Total Threads: ");
            Console.WriteLine(+numberOfThreads + "; Execution time: " + stopWatch.ElapsedMilliseconds + "ms");
            ...
            stopWatch.Stop();
            Console.WriteLine("Type: Run Jobs in Parallel, " + " Number of Processors: " + numberOfProcessors + "; Total Threads: ");
            Console.WriteLine(+numberOfThreads + "; Execution time: " + stopWatch.ElapsedMilliseconds + "ms");
        }
        ...
        private static void Workerfuntion(Object onFinishDelegate)
        {
            ...
            Console.WriteLine("Stopped thread at: {0}", Thread.CurrentThread.Name);
