...
namespace Exercise9
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            using (StreamWriter writer = new StreamWriter(@"C:\Users\chhav\source\repos\UniversityOfAppliedSciencesFrankfurt\se-cloud-2020-2021\MyWork\Exercise9\Parallel.txt"))
            {
