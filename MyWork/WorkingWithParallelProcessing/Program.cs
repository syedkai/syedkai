...
namespace ParallelProcessing
{
    class Program
    {
        ...
        private static void workerFunction(object onFinishDelegate)
        {
            ...
            Console.WriteLine($"Thread begin: {Thread.CurrentThread.Name} - {Thread.CurrentThread.ManagedThreadId}");
            ...
            Console.WriteLine("Thread stopped: {0}", Thread.CurrentThread.Name);
        }
    }
}
