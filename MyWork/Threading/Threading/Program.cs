...
namespace ThreadingSample
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //using (StreamWriter outputFile = new StreamWriter(Path.Combine(docPath, "50Threads5net.txt"), true))  // For 50 threads running in dotnet 5.0
            ...
            using (StreamWriter outputFile = new StreamWriter(Path.Combine(docPath, "150Threads5net.txt"), true))   // For 150 Threads running in dotnet 5.0
            {
